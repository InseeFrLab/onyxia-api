...
public class OnyxiaUserProviderTest {
    ...
    @DisplayName(
            "Given a multi namespace region with a group pattern set "
                    ...
                    + "then the user should have project for its original groups")
    @Test
    public void shouldHaveOriginalGroupInProjectWhenConfWrong() {
        ...
        assertGroupBelongsToUserProjects(simpleUser, "group2-onyxia");
    }
