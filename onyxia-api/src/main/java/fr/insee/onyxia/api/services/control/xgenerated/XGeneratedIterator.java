...
public class XGeneratedIterator {
    ...
    public void iterateOverContext(
            XGeneratedContext context,
        ...
        context.getScopes()
                .forEach(
                        (scopeName, scope) -> {
                            scope.getxGenerateds()
                                    .forEach(
                                            (name, xGenerated) -> {
                                                if (xGenerated.getType()
                                                        == Property.XGenerated.XGeneratedType
                                                                .AppID) {
                                                    xGeneratedValues.put(
                                                            name,
                                                            xGeneratedProvider.getAppId(
                                                                    scopeName, scope, xGenerated));
                                                }
                                                if (xGenerated.getType()
                                                        == Property.XGenerated.XGeneratedType
                                                                .ExternalDNS) {
                                                    xGeneratedValues.put(
                                                            name,
                                                            xGeneratedProvider.getExternalDns(
                                                                    scopeName, scope, xGenerated));
                                                }
                                                ...
                                                if (xGenerated.getType()
                                                    ...
                                                    xGeneratedValues.put(
                                                            name,
                                                            xGeneratedProvider.getInternalDns(
                                                                    scopeName, scope, xGenerated));
                                                }
                                                if (xGenerated.getType()
                                                        == Property.XGenerated.XGeneratedType
                                                    ...
                                                    xGeneratedValues.put(
                                                            name,
                                                            xGeneratedProvider.getInitScript(
                                                                    scopeName, scope, xGenerated));
                                                }
                                            });
                        });
